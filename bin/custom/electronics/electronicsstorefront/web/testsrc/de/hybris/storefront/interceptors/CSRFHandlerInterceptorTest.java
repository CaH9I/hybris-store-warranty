 ...
 */
package de.hybris.storefront.interceptors;
...
import de.hybris.storefront.util.CSRFHandlerInterceptor;
import de.hybris.storefront.util.CSRFTokenManager;
...
public class CSRFHandlerInterceptorTest extends ServicelayerTest
{
	...
	private static final String SESSION_CSRF_ATTRIBUTE = "de.hybris.storefront.util.CSRFTokenManager.tokenval";
