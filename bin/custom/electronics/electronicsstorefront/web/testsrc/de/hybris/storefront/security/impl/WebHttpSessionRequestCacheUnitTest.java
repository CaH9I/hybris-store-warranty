...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/electronicsstorefront/electronics/en",
						"https://electronics.local:9002/electronicsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/electronicsstorefront/electronics/en",
						"https://electronics.local:9002/electronicsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/electronicsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/electronicsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/electronicsstorefront/electronics/en",
						"https://electronics.local:9002/electronicsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/electronicsstorefront",
						"https://electronics.local:9002/electronicsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/electronicsstorefront",
						"https://electronics.local:9002/electronicsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/electronicsstorefront/electronics/en",
						"https://electronics.local:9002/electronicsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
