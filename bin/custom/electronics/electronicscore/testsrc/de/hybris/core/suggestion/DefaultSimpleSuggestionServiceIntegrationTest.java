 ...
 */
package de.hybris.core.suggestion;
...
import de.hybris.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/electronicscore/test/testSimpleSuggestionService.csv", "utf-8");
	}
