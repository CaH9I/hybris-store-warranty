 ...
 */
package de.hybris.fulfilmentprocess.test.jobs;
...
import de.hybris.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = ElectronicsFulfilmentProcessConstants.ORDER_PROCESS_NAME;
