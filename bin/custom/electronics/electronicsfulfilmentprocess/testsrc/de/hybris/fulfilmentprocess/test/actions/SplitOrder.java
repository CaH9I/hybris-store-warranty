 ...
 */
package de.hybris.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(ElectronicsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ElectronicsFulfilmentProcessConstants.PARENT_PROCESS);
